def my_hash
  my_hash = {"Jim" => "Extra!", "Janine" => "CounterSpin", "Julie" => "Managing"}# use the literal constructor to set the variable, my_hash, equal to a hash with key/value pairs of your choice.  
end
